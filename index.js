...
bot.onText(/💰 Deposit/, (msg) => {
  ...
  const keyboard = {
    reply_markup: {
      inline_keyboard: [
        [{ text: 'Rp 10.000', callback_data: 'deposit_10000' }, { text: 'Rp 20.000', callback_data: 'deposit_20000' }],
        [{ text: 'Rp 50.000', callback_data: 'deposit_50000' }, { text: 'Rp 100.000', callback_data: 'deposit_100000' }],
        [{ text: 'Rp 200.000', callback_data: 'deposit_200000' }, { text: 'Rp 500.000', callback_data: 'deposit_500000' }],
  ...
  bot.sendMessage(chatId, '💰 *Deposit Saldo*\n\nPilih nominal deposit (minimal Rp 10.000):', { ...keyboard, parse_mode: 'Markdown' });
});
